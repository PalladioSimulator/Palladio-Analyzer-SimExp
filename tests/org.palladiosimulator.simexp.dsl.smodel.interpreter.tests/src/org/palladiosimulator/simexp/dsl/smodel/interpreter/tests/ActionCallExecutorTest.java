...
public class ActionCallExecutorTest {
    ...
    public void testExecuteActionNoArguments() {
        ...
        ParameterList parameterList = smodelFactory.createParameterList();
        action.setParameterList(parameterList);
    ...
    public void testExecuteActionWithSingleParameterInt() {
        ...
        action.setParameterList(parameterList);
        actionCall.setActionRef(action);
        ArgumentKeyValue argumentKeyValue = smodelFactory.createArgumentKeyValue();
