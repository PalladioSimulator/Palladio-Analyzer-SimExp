...
public class KubernetesPreferenceInitializer extends AbstractPreferenceInitializer {
    ...
    public void initializeDefaultPreferences() {
        ...
        defaults.put(KubernetesPreferenceConstants.INTERNAL_RABBIT_MQ_URL,
                "https://rabbitmq-service.messaging.svc:5672");
        defaults.put(KubernetesPreferenceConstants.INTERNAL_IMAGE_REGISTRY_URL,
                "http://image-registry.images.svc.cluster.local:5000");
        ...
        defaults.putInt(KubernetesPreferenceConstants.RABBIT_MAX_DELIVERY, 3);
    }
}
