...
public class KmodelValueSwitch extends KmodelSwitch<Object> {
	...
	public Object doSwitch(EObject object) {
		...
		if (result == null) {
			throw new RuntimeException("Couldn't determine the value of objects of class '" + object.eClass().getName() + "'.");
		}
	...
	public Object caseVariable(Variable variable) {
		...
		if (value == null) {
			throw new RuntimeException("The VariableValueProvider couldn't provide a value for variable '" + variable.getName() + "'.");
		}
	...
	public Object caseExpression(Expression expression) {
		...
		default:
			throw new RuntimeException("Couldn't determine the value of an expression with operation '" + operation + "'.");
		}
	}
}
