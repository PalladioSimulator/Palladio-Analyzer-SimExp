...
public class PcmMeasurementSpecificationProvider {
    ...
    private PcmMeasurementSpecification buildResponseTimeSpec() {
        ...
        MeasurementSpecification rtSpec = rtMonitor.getMeasurementSpecifications()
            .get(0);
    ...
    private PcmMeasurementSpecification buildCpuUtilizationSpecOf(String monitorName) {
        ...
        MeasurementSpecification spec = monitor.getMeasurementSpecifications()
            .get(1);
    ...
    private Monitor findMonitor(String monitorName) {
        Stream<Monitor> monitors = experiment.getInitialModel()
            ...
            .getMonitors()
            .stream();
        return monitors.filter(m -> m.getEntityName()
            .equals(monitorName))
            .findFirst()
            .orElseThrow(() -> new RuntimeException("There is no monitor '" + monitorName + "' ."));
    }
}
