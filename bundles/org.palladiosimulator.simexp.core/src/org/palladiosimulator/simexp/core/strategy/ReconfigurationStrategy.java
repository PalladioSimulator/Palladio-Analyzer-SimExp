...
public abstract class ReconfigurationStrategy<S, P, A extends Reconfiguration<P>> implements Policy<S, P, A> {
    ...
    protected abstract A plan(State<S> source, Set<A> options, SharedKnowledge knowledge);
