...
public class PcmMeasurementSpecification extends SimulatedMeasurementSpecification {
		...
		public static MeasurementAggregator getDefault() {
			return new MeasurementAggregator() {
				...
				public double aggregate(MeasurementSeries measurements) {
					return StatisticalQuantities.withNumbers(measurements.asListOfValues()).mean();
				}
			};
		}
	...
	public static class PcmMeasurementSpecBuilder {
		...
		public PcmMeasurementSpecification build() {
			...
			return new PcmMeasurementSpecification(deriveUniqueId(measuringPoint, metricDescription),name, measuringPoint, metricDescription, aggregator, steadyStateEvaluator);
		}
	...
	private PcmMeasurementSpecification(String id, 
										String name, 
