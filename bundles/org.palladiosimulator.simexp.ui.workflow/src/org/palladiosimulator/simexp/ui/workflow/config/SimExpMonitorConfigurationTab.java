...
public class SimExpMonitorConfigurationTab extends AbstractLaunchConfigurationTab {
    ...
    @Override
    public String getId() {
        return "org.palladiosimulator.simexp.ui.workflow.config.SimExpMonitorConfigurationTab";
    }
