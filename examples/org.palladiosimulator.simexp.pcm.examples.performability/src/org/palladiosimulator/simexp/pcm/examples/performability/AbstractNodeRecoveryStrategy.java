...
public abstract class AbstractNodeRecoveryStrategy implements NodeRecoveryStrategy {
    ...
    @Override
    public abstract void execute(SelfAdaptiveSystemState<?> sasState, SharedKnowledge knowledge);
    
    
    protected  ProbabilisticBranchTransition findProbabilisticBranchTransitionToServerNode(
    ...
    protected void logMsg(String node1EntiyName, String node2EntiyName, String node1Id, String node2Id, String node1State, String node2State
            , double probBranchTransitionToServerNode1, double probBranchTransitionToServerNode2) {
        LOGGER.debug(String.format("Performed node recovery - (enityName,id,state,branch probability): [%s,%s,%s,%s], [%s,%s,%s, %s]"
                , node1EntiyName, node1Id, node1State, probBranchTransitionToServerNode1
                , node2EntiyName, node2Id, node2State, probBranchTransitionToServerNode2));
    }
